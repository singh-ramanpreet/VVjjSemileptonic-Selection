...
bool passEleLoose(const baconhep::TElectron *electron, float iso);
bool passEleTight(const baconhep::TElectron *electron, float iso);
float eleEffArea(const float eta);
...
bool passEleLoose(const baconhep::TElectron *electron, float iso)
{
  ...
  float rho = eleEffArea(electron->eta);
