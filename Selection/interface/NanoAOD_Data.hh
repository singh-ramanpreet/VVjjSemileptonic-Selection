...
// Sun Apr 12 03:28:56 2020 by ROOT version 6.12/07
// from TTree NanoAOD_Data/NanoAOD_Data
// found on file: root://cmseos.fnal.gov//store/user/lnujj/VVjj_aQGC/nanoAOD_skim/Run2018_v6/EGamma/Run2018D/200408_094108/E929D991-9850-BA4A-A103-FCF9FE2D5098_Skim.root
//////////////////////////////////////////////////////////

#ifndef NanoAOD_Data_h
#define NanoAOD_Data_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nPhoton;
   Float_t         Photon_eCorr[12];   //[nPhoton]
   Float_t         Photon_energyErr[12];   //[nPhoton]
   Float_t         Photon_eta[12];   //[nPhoton]
   Float_t         Photon_hoe[12];   //[nPhoton]
   Float_t         Photon_mass[12];   //[nPhoton]
   Float_t         Photon_mvaID[12];   //[nPhoton]
   Float_t         Photon_mvaIDV1[12];   //[nPhoton]
   Float_t         Photon_pfRelIso03_all[12];   //[nPhoton]
   Float_t         Photon_pfRelIso03_chg[12];   //[nPhoton]
   Float_t         Photon_phi[12];   //[nPhoton]
   Float_t         Photon_pt[12];   //[nPhoton]
   Float_t         Photon_r9[12];   //[nPhoton]
   Float_t         Photon_sieie[12];   //[nPhoton]
   Int_t           Photon_charge[12];   //[nPhoton]
   Int_t           Photon_cutBasedBitmap[12];   //[nPhoton]
   Int_t           Photon_cutBasedV1Bitmap[12];   //[nPhoton]
   Int_t           Photon_electronIdx[12];   //[nPhoton]
   Int_t           Photon_jetIdx[12];   //[nPhoton]
   Int_t           Photon_pdgId[12];   //[nPhoton]
   Int_t           Photon_vidNestedWPBitmap[12];   //[nPhoton]
   Bool_t          Photon_electronVeto[12];   //[nPhoton]
   Bool_t          Photon_isScEtaEB[12];   //[nPhoton]
   Bool_t          Photon_isScEtaEE[12];   //[nPhoton]
   Bool_t          Photon_mvaID_WP80[12];   //[nPhoton]
   Bool_t          Photon_mvaID_WP90[12];   //[nPhoton]
   Bool_t          Photon_pixelSeed[12];   //[nPhoton]
   UChar_t         Photon_seedGain[12];   //[nPhoton]
   ...
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[31];   //[nTrigObj]
   Float_t         TrigObj_eta[31];   //[nTrigObj]
   Float_t         TrigObj_phi[31];   //[nTrigObj]
   Float_t         TrigObj_l1pt[31];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[31];   //[nTrigObj]
   Float_t         TrigObj_l2pt[31];   //[nTrigObj]
   Int_t           TrigObj_id[31];   //[nTrigObj]
   ...
   UChar_t         Photon_cleanmask[12];   //[nPhoton]
  ...
  NanoAOD_Data(TTree *tree=0) {
    if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmseos.fnal.gov//store/user/lnujj/VVjj_aQGC/nanoAOD_skim/Run2018_v6/EGamma/Run2018D/200408_094108/E929D991-9850-BA4A-A103-FCF9FE2D5098_Skim.root");
      if (!f || !f->IsOpen()) {
	f = new TFile("root://cmseos.fnal.gov//store/user/lnujj/VVjj_aQGC/nanoAOD_skim/Run2018_v6/EGamma/Run2018D/200408_094108/E929D991-9850-BA4A-A103-FCF9FE2D5098_Skim.root");
      }
...
Int_t NanoAOD_Data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NanoAOD_Data::LoadTree(Long64_t entry)
{
...
void NanoAOD_Data::Init(TTree *tree)
{
