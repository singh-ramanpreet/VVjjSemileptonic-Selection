...
// Thu Oct 22 06:18:59 2020 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: root://cmseos.fnal.gov//store/user/lnujj/VVjj_aQGC/nanoAOD_skim/Run2017_v7_18Aug2020_Hadd/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/200817_180337/E182A615-DCDA-1D46-B003-E9F70E9CE382_SkimHadd.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nJet;
   Float_t         Jet_area[36];   //[nJet]
   Float_t         Jet_btagCMVA[36];   //[nJet]
   Float_t         Jet_btagCSVV2[36];   //[nJet]
   Float_t         Jet_btagDeepB[36];   //[nJet]
   Float_t         Jet_btagDeepC[36];   //[nJet]
   Float_t         Jet_btagDeepFlavB[36];   //[nJet]
   Float_t         Jet_btagDeepFlavC[36];   //[nJet]
   Float_t         Jet_chEmEF[36];   //[nJet]
   Float_t         Jet_chFPV0EF[36];   //[nJet]
   Float_t         Jet_chFPV1EF[36];   //[nJet]
   Float_t         Jet_chFPV2EF[36];   //[nJet]
   Float_t         Jet_chFPV3EF[36];   //[nJet]
   Float_t         Jet_chHEF[36];   //[nJet]
   Float_t         Jet_eta[36];   //[nJet]
   Float_t         Jet_mass[36];   //[nJet]
   Float_t         Jet_muEF[36];   //[nJet]
   Float_t         Jet_muonSubtrFactor[36];   //[nJet]
   Float_t         Jet_neEmEF[36];   //[nJet]
   Float_t         Jet_neHEF[36];   //[nJet]
   Float_t         Jet_phi[36];   //[nJet]
   Float_t         Jet_pt[36];   //[nJet]
   Float_t         Jet_puIdDisc[36];   //[nJet]
   Float_t         Jet_qgl[36];   //[nJet]
   Float_t         Jet_rawFactor[36];   //[nJet]
   Float_t         Jet_bRegCorr[36];   //[nJet]
   Float_t         Jet_bRegRes[36];   //[nJet]
   Float_t         Jet_cRegCorr[36];   //[nJet]
   Float_t         Jet_cRegRes[36];   //[nJet]
   Int_t           Jet_electronIdx1[36];   //[nJet]
   Int_t           Jet_electronIdx2[36];   //[nJet]
   Int_t           Jet_jetId[36];   //[nJet]
   Int_t           Jet_muonIdx1[36];   //[nJet]
   Int_t           Jet_muonIdx2[36];   //[nJet]
   Int_t           Jet_nConstituents[36];   //[nJet]
   Int_t           Jet_nElectrons[36];   //[nJet]
   Int_t           Jet_nMuons[36];   //[nJet]
   Int_t           Jet_puId[36];   //[nJet]
   ...
   Int_t           Jet_genJetIdx[36];   //[nJet]
   Int_t           Jet_hadronFlavour[36];   //[nJet]
   Int_t           Jet_partonFlavour[36];   //[nJet]
   ...
   Float_t         Jet_pt_raw[36];   //[nJet]
   Float_t         Jet_pt_nom[36];   //[nJet]
   Float_t         Jet_mass_raw[36];   //[nJet]
   Float_t         Jet_mass_nom[36];   //[nJet]
   Float_t         Jet_corr_JEC[36];   //[nJet]
   Float_t         Jet_corr_JER[36];   //[nJet]
   Float_t         MET_pt_nom;
   Float_t         MET_phi_nom;
   Float_t         MET_pt_jer;
   Float_t         MET_phi_jer;
   Float_t         Jet_pt_jerUp[36];   //[nJet]
   Float_t         Jet_mass_jerUp[36];   //[nJet]
   Float_t         MET_pt_jerUp;
   Float_t         MET_phi_jerUp;
   Float_t         Jet_pt_jesAbsoluteStatUp[36];   //[nJet]
   Float_t         Jet_mass_jesAbsoluteStatUp[36];   //[nJet]
   Float_t         MET_pt_jesAbsoluteStatUp;
   Float_t         MET_phi_jesAbsoluteStatUp;
   Float_t         Jet_pt_jesAbsoluteScaleUp[36];   //[nJet]
   Float_t         Jet_mass_jesAbsoluteScaleUp[36];   //[nJet]
   Float_t         MET_pt_jesAbsoluteScaleUp;
   Float_t         MET_phi_jesAbsoluteScaleUp;
   Float_t         Jet_pt_jesAbsoluteFlavMapUp[36];   //[nJet]
   Float_t         Jet_mass_jesAbsoluteFlavMapUp[36];   //[nJet]
   Float_t         MET_pt_jesAbsoluteFlavMapUp;
   Float_t         MET_phi_jesAbsoluteFlavMapUp;
   Float_t         Jet_pt_jesAbsoluteMPFBiasUp[36];   //[nJet]
   Float_t         Jet_mass_jesAbsoluteMPFBiasUp[36];   //[nJet]
   Float_t         MET_pt_jesAbsoluteMPFBiasUp;
   Float_t         MET_phi_jesAbsoluteMPFBiasUp;
   Float_t         Jet_pt_jesFragmentationUp[36];   //[nJet]
   Float_t         Jet_mass_jesFragmentationUp[36];   //[nJet]
   Float_t         MET_pt_jesFragmentationUp;
   Float_t         MET_phi_jesFragmentationUp;
   Float_t         Jet_pt_jesSinglePionECALUp[36];   //[nJet]
   Float_t         Jet_mass_jesSinglePionECALUp[36];   //[nJet]
   Float_t         MET_pt_jesSinglePionECALUp;
   Float_t         MET_phi_jesSinglePionECALUp;
   Float_t         Jet_pt_jesSinglePionHCALUp[36];   //[nJet]
   Float_t         Jet_mass_jesSinglePionHCALUp[36];   //[nJet]
   Float_t         MET_pt_jesSinglePionHCALUp;
   Float_t         MET_phi_jesSinglePionHCALUp;
   Float_t         Jet_pt_jesFlavorQCDUp[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorQCDUp[36];   //[nJet]
   Float_t         MET_pt_jesFlavorQCDUp;
   Float_t         MET_phi_jesFlavorQCDUp;
   Float_t         Jet_pt_jesTimePtEtaUp[36];   //[nJet]
   Float_t         Jet_mass_jesTimePtEtaUp[36];   //[nJet]
   Float_t         MET_pt_jesTimePtEtaUp;
   Float_t         MET_phi_jesTimePtEtaUp;
   Float_t         Jet_pt_jesRelativeJEREC1Up[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeJEREC1Up[36];   //[nJet]
   Float_t         MET_pt_jesRelativeJEREC1Up;
   Float_t         MET_phi_jesRelativeJEREC1Up;
   Float_t         Jet_pt_jesRelativeJEREC2Up[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeJEREC2Up[36];   //[nJet]
   Float_t         MET_pt_jesRelativeJEREC2Up;
   Float_t         MET_phi_jesRelativeJEREC2Up;
   Float_t         Jet_pt_jesRelativeJERHFUp[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeJERHFUp[36];   //[nJet]
   Float_t         MET_pt_jesRelativeJERHFUp;
   Float_t         MET_phi_jesRelativeJERHFUp;
   Float_t         Jet_pt_jesRelativePtBBUp[36];   //[nJet]
   Float_t         Jet_mass_jesRelativePtBBUp[36];   //[nJet]
   Float_t         MET_pt_jesRelativePtBBUp;
   Float_t         MET_phi_jesRelativePtBBUp;
   Float_t         Jet_pt_jesRelativePtEC1Up[36];   //[nJet]
   Float_t         Jet_mass_jesRelativePtEC1Up[36];   //[nJet]
   Float_t         MET_pt_jesRelativePtEC1Up;
   Float_t         MET_phi_jesRelativePtEC1Up;
   Float_t         Jet_pt_jesRelativePtEC2Up[36];   //[nJet]
   Float_t         Jet_mass_jesRelativePtEC2Up[36];   //[nJet]
   Float_t         MET_pt_jesRelativePtEC2Up;
   Float_t         MET_phi_jesRelativePtEC2Up;
   Float_t         Jet_pt_jesRelativePtHFUp[36];   //[nJet]
   Float_t         Jet_mass_jesRelativePtHFUp[36];   //[nJet]
   Float_t         MET_pt_jesRelativePtHFUp;
   Float_t         MET_phi_jesRelativePtHFUp;
   Float_t         Jet_pt_jesRelativeBalUp[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeBalUp[36];   //[nJet]
   Float_t         MET_pt_jesRelativeBalUp;
   Float_t         MET_phi_jesRelativeBalUp;
   Float_t         Jet_pt_jesRelativeSampleUp[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeSampleUp[36];   //[nJet]
   Float_t         MET_pt_jesRelativeSampleUp;
   Float_t         MET_phi_jesRelativeSampleUp;
   Float_t         Jet_pt_jesRelativeFSRUp[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeFSRUp[36];   //[nJet]
   Float_t         MET_pt_jesRelativeFSRUp;
   Float_t         MET_phi_jesRelativeFSRUp;
   Float_t         Jet_pt_jesRelativeStatFSRUp[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeStatFSRUp[36];   //[nJet]
   Float_t         MET_pt_jesRelativeStatFSRUp;
   Float_t         MET_phi_jesRelativeStatFSRUp;
   Float_t         Jet_pt_jesRelativeStatECUp[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeStatECUp[36];   //[nJet]
   Float_t         MET_pt_jesRelativeStatECUp;
   Float_t         MET_phi_jesRelativeStatECUp;
   Float_t         Jet_pt_jesRelativeStatHFUp[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeStatHFUp[36];   //[nJet]
   Float_t         MET_pt_jesRelativeStatHFUp;
   Float_t         MET_phi_jesRelativeStatHFUp;
   Float_t         Jet_pt_jesPileUpDataMCUp[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpDataMCUp[36];   //[nJet]
   Float_t         MET_pt_jesPileUpDataMCUp;
   Float_t         MET_phi_jesPileUpDataMCUp;
   Float_t         Jet_pt_jesPileUpPtRefUp[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpPtRefUp[36];   //[nJet]
   Float_t         MET_pt_jesPileUpPtRefUp;
   Float_t         MET_phi_jesPileUpPtRefUp;
   Float_t         Jet_pt_jesPileUpPtBBUp[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpPtBBUp[36];   //[nJet]
   Float_t         MET_pt_jesPileUpPtBBUp;
   Float_t         MET_phi_jesPileUpPtBBUp;
   Float_t         Jet_pt_jesPileUpPtEC1Up[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpPtEC1Up[36];   //[nJet]
   Float_t         MET_pt_jesPileUpPtEC1Up;
   Float_t         MET_phi_jesPileUpPtEC1Up;
   Float_t         Jet_pt_jesPileUpPtEC2Up[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpPtEC2Up[36];   //[nJet]
   Float_t         MET_pt_jesPileUpPtEC2Up;
   Float_t         MET_phi_jesPileUpPtEC2Up;
   Float_t         Jet_pt_jesPileUpPtHFUp[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpPtHFUp[36];   //[nJet]
   Float_t         MET_pt_jesPileUpPtHFUp;
   Float_t         MET_phi_jesPileUpPtHFUp;
   Float_t         Jet_pt_jesPileUpMuZeroUp[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpMuZeroUp[36];   //[nJet]
   Float_t         MET_pt_jesPileUpMuZeroUp;
   Float_t         MET_phi_jesPileUpMuZeroUp;
   Float_t         Jet_pt_jesPileUpEnvelopeUp[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpEnvelopeUp[36];   //[nJet]
   Float_t         MET_pt_jesPileUpEnvelopeUp;
   Float_t         MET_phi_jesPileUpEnvelopeUp;
   Float_t         Jet_pt_jesSubTotalPileUpUp[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalPileUpUp[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalPileUpUp;
   Float_t         MET_phi_jesSubTotalPileUpUp;
   Float_t         Jet_pt_jesSubTotalRelativeUp[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalRelativeUp[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalRelativeUp;
   Float_t         MET_phi_jesSubTotalRelativeUp;
   Float_t         Jet_pt_jesSubTotalPtUp[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalPtUp[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalPtUp;
   Float_t         MET_phi_jesSubTotalPtUp;
   Float_t         Jet_pt_jesSubTotalScaleUp[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalScaleUp[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalScaleUp;
   Float_t         MET_phi_jesSubTotalScaleUp;
   Float_t         Jet_pt_jesSubTotalAbsoluteUp[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalAbsoluteUp[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalAbsoluteUp;
   Float_t         MET_phi_jesSubTotalAbsoluteUp;
   Float_t         Jet_pt_jesSubTotalMCUp[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalMCUp[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalMCUp;
   Float_t         MET_phi_jesSubTotalMCUp;
   Float_t         Jet_pt_jesTotalUp[36];   //[nJet]
   Float_t         Jet_mass_jesTotalUp[36];   //[nJet]
   Float_t         MET_pt_jesTotalUp;
   Float_t         MET_phi_jesTotalUp;
   Float_t         Jet_pt_jesTotalNoFlavorUp[36];   //[nJet]
   Float_t         Jet_mass_jesTotalNoFlavorUp[36];   //[nJet]
   Float_t         MET_pt_jesTotalNoFlavorUp;
   Float_t         MET_phi_jesTotalNoFlavorUp;
   Float_t         Jet_pt_jesTotalNoTimeUp[36];   //[nJet]
   Float_t         Jet_mass_jesTotalNoTimeUp[36];   //[nJet]
   Float_t         MET_pt_jesTotalNoTimeUp;
   Float_t         MET_phi_jesTotalNoTimeUp;
   Float_t         Jet_pt_jesTotalNoFlavorNoTimeUp[36];   //[nJet]
   Float_t         Jet_mass_jesTotalNoFlavorNoTimeUp[36];   //[nJet]
   Float_t         MET_pt_jesTotalNoFlavorNoTimeUp;
   Float_t         MET_phi_jesTotalNoFlavorNoTimeUp;
   Float_t         Jet_pt_jesFlavorZJetUp[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorZJetUp[36];   //[nJet]
   Float_t         MET_pt_jesFlavorZJetUp;
   Float_t         MET_phi_jesFlavorZJetUp;
   Float_t         Jet_pt_jesFlavorPhotonJetUp[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorPhotonJetUp[36];   //[nJet]
   Float_t         MET_pt_jesFlavorPhotonJetUp;
   Float_t         MET_phi_jesFlavorPhotonJetUp;
   Float_t         Jet_pt_jesFlavorPureGluonUp[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorPureGluonUp[36];   //[nJet]
   Float_t         MET_pt_jesFlavorPureGluonUp;
   Float_t         MET_phi_jesFlavorPureGluonUp;
   Float_t         Jet_pt_jesFlavorPureQuarkUp[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorPureQuarkUp[36];   //[nJet]
   Float_t         MET_pt_jesFlavorPureQuarkUp;
   Float_t         MET_phi_jesFlavorPureQuarkUp;
   Float_t         Jet_pt_jesFlavorPureCharmUp[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorPureCharmUp[36];   //[nJet]
   Float_t         MET_pt_jesFlavorPureCharmUp;
   Float_t         MET_phi_jesFlavorPureCharmUp;
   Float_t         Jet_pt_jesFlavorPureBottomUp[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorPureBottomUp[36];   //[nJet]
   Float_t         MET_pt_jesFlavorPureBottomUp;
   Float_t         MET_phi_jesFlavorPureBottomUp;
   Float_t         Jet_pt_jesTimeRunBUp[36];   //[nJet]
   Float_t         Jet_mass_jesTimeRunBUp[36];   //[nJet]
   Float_t         MET_pt_jesTimeRunBUp;
   Float_t         MET_phi_jesTimeRunBUp;
   Float_t         Jet_pt_jesTimeRunCUp[36];   //[nJet]
   Float_t         Jet_mass_jesTimeRunCUp[36];   //[nJet]
   Float_t         MET_pt_jesTimeRunCUp;
   Float_t         MET_phi_jesTimeRunCUp;
   Float_t         Jet_pt_jesTimeRunDEUp[36];   //[nJet]
   Float_t         Jet_mass_jesTimeRunDEUp[36];   //[nJet]
   Float_t         MET_pt_jesTimeRunDEUp;
   Float_t         MET_phi_jesTimeRunDEUp;
   Float_t         Jet_pt_jesTimeRunFUp[36];   //[nJet]
   Float_t         Jet_mass_jesTimeRunFUp[36];   //[nJet]
   Float_t         MET_pt_jesTimeRunFUp;
   Float_t         MET_phi_jesTimeRunFUp;
   Float_t         Jet_pt_jesCorrelationGroupMPFInSituUp[36];   //[nJet]
   Float_t         Jet_mass_jesCorrelationGroupMPFInSituUp[36];   //[nJet]
   Float_t         MET_pt_jesCorrelationGroupMPFInSituUp;
   Float_t         MET_phi_jesCorrelationGroupMPFInSituUp;
   Float_t         Jet_pt_jesCorrelationGroupIntercalibrationUp[36];   //[nJet]
   Float_t         Jet_mass_jesCorrelationGroupIntercalibrationUp[36];   //[nJet]
   Float_t         MET_pt_jesCorrelationGroupIntercalibrationUp;
   Float_t         MET_phi_jesCorrelationGroupIntercalibrationUp;
   Float_t         Jet_pt_jesCorrelationGroupbJESUp[36];   //[nJet]
   Float_t         Jet_mass_jesCorrelationGroupbJESUp[36];   //[nJet]
   Float_t         MET_pt_jesCorrelationGroupbJESUp;
   Float_t         MET_phi_jesCorrelationGroupbJESUp;
   Float_t         Jet_pt_jesCorrelationGroupFlavorUp[36];   //[nJet]
   Float_t         Jet_mass_jesCorrelationGroupFlavorUp[36];   //[nJet]
   Float_t         MET_pt_jesCorrelationGroupFlavorUp;
   Float_t         MET_phi_jesCorrelationGroupFlavorUp;
   Float_t         Jet_pt_jesCorrelationGroupUncorrelatedUp[36];   //[nJet]
   Float_t         Jet_mass_jesCorrelationGroupUncorrelatedUp[36];   //[nJet]
   ...
   Float_t         Jet_pt_jerDown[36];   //[nJet]
   Float_t         Jet_mass_jerDown[36];   //[nJet]
   Float_t         MET_pt_jerDown;
   Float_t         MET_phi_jerDown;
   Float_t         Jet_pt_jesAbsoluteStatDown[36];   //[nJet]
   Float_t         Jet_mass_jesAbsoluteStatDown[36];   //[nJet]
   Float_t         MET_pt_jesAbsoluteStatDown;
   Float_t         MET_phi_jesAbsoluteStatDown;
   Float_t         Jet_pt_jesAbsoluteScaleDown[36];   //[nJet]
   Float_t         Jet_mass_jesAbsoluteScaleDown[36];   //[nJet]
   Float_t         MET_pt_jesAbsoluteScaleDown;
   Float_t         MET_phi_jesAbsoluteScaleDown;
   Float_t         Jet_pt_jesAbsoluteFlavMapDown[36];   //[nJet]
   Float_t         Jet_mass_jesAbsoluteFlavMapDown[36];   //[nJet]
   Float_t         MET_pt_jesAbsoluteFlavMapDown;
   Float_t         MET_phi_jesAbsoluteFlavMapDown;
   Float_t         Jet_pt_jesAbsoluteMPFBiasDown[36];   //[nJet]
   Float_t         Jet_mass_jesAbsoluteMPFBiasDown[36];   //[nJet]
   Float_t         MET_pt_jesAbsoluteMPFBiasDown;
   Float_t         MET_phi_jesAbsoluteMPFBiasDown;
   Float_t         Jet_pt_jesFragmentationDown[36];   //[nJet]
   Float_t         Jet_mass_jesFragmentationDown[36];   //[nJet]
   Float_t         MET_pt_jesFragmentationDown;
   Float_t         MET_phi_jesFragmentationDown;
   Float_t         Jet_pt_jesSinglePionECALDown[36];   //[nJet]
   Float_t         Jet_mass_jesSinglePionECALDown[36];   //[nJet]
   Float_t         MET_pt_jesSinglePionECALDown;
   Float_t         MET_phi_jesSinglePionECALDown;
   Float_t         Jet_pt_jesSinglePionHCALDown[36];   //[nJet]
   Float_t         Jet_mass_jesSinglePionHCALDown[36];   //[nJet]
   Float_t         MET_pt_jesSinglePionHCALDown;
   Float_t         MET_phi_jesSinglePionHCALDown;
   Float_t         Jet_pt_jesFlavorQCDDown[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorQCDDown[36];   //[nJet]
   Float_t         MET_pt_jesFlavorQCDDown;
   Float_t         MET_phi_jesFlavorQCDDown;
   Float_t         Jet_pt_jesTimePtEtaDown[36];   //[nJet]
   Float_t         Jet_mass_jesTimePtEtaDown[36];   //[nJet]
   Float_t         MET_pt_jesTimePtEtaDown;
   Float_t         MET_phi_jesTimePtEtaDown;
   Float_t         Jet_pt_jesRelativeJEREC1Down[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeJEREC1Down[36];   //[nJet]
   Float_t         MET_pt_jesRelativeJEREC1Down;
   Float_t         MET_phi_jesRelativeJEREC1Down;
   Float_t         Jet_pt_jesRelativeJEREC2Down[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeJEREC2Down[36];   //[nJet]
   Float_t         MET_pt_jesRelativeJEREC2Down;
   Float_t         MET_phi_jesRelativeJEREC2Down;
   Float_t         Jet_pt_jesRelativeJERHFDown[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeJERHFDown[36];   //[nJet]
   Float_t         MET_pt_jesRelativeJERHFDown;
   Float_t         MET_phi_jesRelativeJERHFDown;
   Float_t         Jet_pt_jesRelativePtBBDown[36];   //[nJet]
   Float_t         Jet_mass_jesRelativePtBBDown[36];   //[nJet]
   Float_t         MET_pt_jesRelativePtBBDown;
   Float_t         MET_phi_jesRelativePtBBDown;
   Float_t         Jet_pt_jesRelativePtEC1Down[36];   //[nJet]
   Float_t         Jet_mass_jesRelativePtEC1Down[36];   //[nJet]
   Float_t         MET_pt_jesRelativePtEC1Down;
   Float_t         MET_phi_jesRelativePtEC1Down;
   Float_t         Jet_pt_jesRelativePtEC2Down[36];   //[nJet]
   Float_t         Jet_mass_jesRelativePtEC2Down[36];   //[nJet]
   Float_t         MET_pt_jesRelativePtEC2Down;
   Float_t         MET_phi_jesRelativePtEC2Down;
   Float_t         Jet_pt_jesRelativePtHFDown[36];   //[nJet]
   Float_t         Jet_mass_jesRelativePtHFDown[36];   //[nJet]
   Float_t         MET_pt_jesRelativePtHFDown;
   Float_t         MET_phi_jesRelativePtHFDown;
   Float_t         Jet_pt_jesRelativeBalDown[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeBalDown[36];   //[nJet]
   Float_t         MET_pt_jesRelativeBalDown;
   Float_t         MET_phi_jesRelativeBalDown;
   Float_t         Jet_pt_jesRelativeSampleDown[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeSampleDown[36];   //[nJet]
   Float_t         MET_pt_jesRelativeSampleDown;
   Float_t         MET_phi_jesRelativeSampleDown;
   Float_t         Jet_pt_jesRelativeFSRDown[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeFSRDown[36];   //[nJet]
   Float_t         MET_pt_jesRelativeFSRDown;
   Float_t         MET_phi_jesRelativeFSRDown;
   Float_t         Jet_pt_jesRelativeStatFSRDown[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeStatFSRDown[36];   //[nJet]
   Float_t         MET_pt_jesRelativeStatFSRDown;
   Float_t         MET_phi_jesRelativeStatFSRDown;
   Float_t         Jet_pt_jesRelativeStatECDown[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeStatECDown[36];   //[nJet]
   Float_t         MET_pt_jesRelativeStatECDown;
   Float_t         MET_phi_jesRelativeStatECDown;
   Float_t         Jet_pt_jesRelativeStatHFDown[36];   //[nJet]
   Float_t         Jet_mass_jesRelativeStatHFDown[36];   //[nJet]
   Float_t         MET_pt_jesRelativeStatHFDown;
   Float_t         MET_phi_jesRelativeStatHFDown;
   Float_t         Jet_pt_jesPileUpDataMCDown[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpDataMCDown[36];   //[nJet]
   Float_t         MET_pt_jesPileUpDataMCDown;
   Float_t         MET_phi_jesPileUpDataMCDown;
   Float_t         Jet_pt_jesPileUpPtRefDown[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpPtRefDown[36];   //[nJet]
   Float_t         MET_pt_jesPileUpPtRefDown;
   Float_t         MET_phi_jesPileUpPtRefDown;
   Float_t         Jet_pt_jesPileUpPtBBDown[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpPtBBDown[36];   //[nJet]
   Float_t         MET_pt_jesPileUpPtBBDown;
   Float_t         MET_phi_jesPileUpPtBBDown;
   Float_t         Jet_pt_jesPileUpPtEC1Down[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpPtEC1Down[36];   //[nJet]
   Float_t         MET_pt_jesPileUpPtEC1Down;
   Float_t         MET_phi_jesPileUpPtEC1Down;
   Float_t         Jet_pt_jesPileUpPtEC2Down[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpPtEC2Down[36];   //[nJet]
   Float_t         MET_pt_jesPileUpPtEC2Down;
   Float_t         MET_phi_jesPileUpPtEC2Down;
   Float_t         Jet_pt_jesPileUpPtHFDown[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpPtHFDown[36];   //[nJet]
   Float_t         MET_pt_jesPileUpPtHFDown;
   Float_t         MET_phi_jesPileUpPtHFDown;
   Float_t         Jet_pt_jesPileUpMuZeroDown[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpMuZeroDown[36];   //[nJet]
   Float_t         MET_pt_jesPileUpMuZeroDown;
   Float_t         MET_phi_jesPileUpMuZeroDown;
   Float_t         Jet_pt_jesPileUpEnvelopeDown[36];   //[nJet]
   Float_t         Jet_mass_jesPileUpEnvelopeDown[36];   //[nJet]
   Float_t         MET_pt_jesPileUpEnvelopeDown;
   Float_t         MET_phi_jesPileUpEnvelopeDown;
   Float_t         Jet_pt_jesSubTotalPileUpDown[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalPileUpDown[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalPileUpDown;
   Float_t         MET_phi_jesSubTotalPileUpDown;
   Float_t         Jet_pt_jesSubTotalRelativeDown[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalRelativeDown[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalRelativeDown;
   Float_t         MET_phi_jesSubTotalRelativeDown;
   Float_t         Jet_pt_jesSubTotalPtDown[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalPtDown[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalPtDown;
   Float_t         MET_phi_jesSubTotalPtDown;
   Float_t         Jet_pt_jesSubTotalScaleDown[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalScaleDown[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalScaleDown;
   Float_t         MET_phi_jesSubTotalScaleDown;
   Float_t         Jet_pt_jesSubTotalAbsoluteDown[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalAbsoluteDown[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalAbsoluteDown;
   Float_t         MET_phi_jesSubTotalAbsoluteDown;
   Float_t         Jet_pt_jesSubTotalMCDown[36];   //[nJet]
   Float_t         Jet_mass_jesSubTotalMCDown[36];   //[nJet]
   Float_t         MET_pt_jesSubTotalMCDown;
   Float_t         MET_phi_jesSubTotalMCDown;
   Float_t         Jet_pt_jesTotalDown[36];   //[nJet]
   Float_t         Jet_mass_jesTotalDown[36];   //[nJet]
   Float_t         MET_pt_jesTotalDown;
   Float_t         MET_phi_jesTotalDown;
   Float_t         Jet_pt_jesTotalNoFlavorDown[36];   //[nJet]
   Float_t         Jet_mass_jesTotalNoFlavorDown[36];   //[nJet]
   Float_t         MET_pt_jesTotalNoFlavorDown;
   Float_t         MET_phi_jesTotalNoFlavorDown;
   Float_t         Jet_pt_jesTotalNoTimeDown[36];   //[nJet]
   Float_t         Jet_mass_jesTotalNoTimeDown[36];   //[nJet]
   Float_t         MET_pt_jesTotalNoTimeDown;
   Float_t         MET_phi_jesTotalNoTimeDown;
   Float_t         Jet_pt_jesTotalNoFlavorNoTimeDown[36];   //[nJet]
   Float_t         Jet_mass_jesTotalNoFlavorNoTimeDown[36];   //[nJet]
   Float_t         MET_pt_jesTotalNoFlavorNoTimeDown;
   Float_t         MET_phi_jesTotalNoFlavorNoTimeDown;
   Float_t         Jet_pt_jesFlavorZJetDown[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorZJetDown[36];   //[nJet]
   Float_t         MET_pt_jesFlavorZJetDown;
   Float_t         MET_phi_jesFlavorZJetDown;
   Float_t         Jet_pt_jesFlavorPhotonJetDown[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorPhotonJetDown[36];   //[nJet]
   Float_t         MET_pt_jesFlavorPhotonJetDown;
   Float_t         MET_phi_jesFlavorPhotonJetDown;
   Float_t         Jet_pt_jesFlavorPureGluonDown[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorPureGluonDown[36];   //[nJet]
   Float_t         MET_pt_jesFlavorPureGluonDown;
   Float_t         MET_phi_jesFlavorPureGluonDown;
   Float_t         Jet_pt_jesFlavorPureQuarkDown[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorPureQuarkDown[36];   //[nJet]
   Float_t         MET_pt_jesFlavorPureQuarkDown;
   Float_t         MET_phi_jesFlavorPureQuarkDown;
   Float_t         Jet_pt_jesFlavorPureCharmDown[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorPureCharmDown[36];   //[nJet]
   Float_t         MET_pt_jesFlavorPureCharmDown;
   Float_t         MET_phi_jesFlavorPureCharmDown;
   Float_t         Jet_pt_jesFlavorPureBottomDown[36];   //[nJet]
   Float_t         Jet_mass_jesFlavorPureBottomDown[36];   //[nJet]
   Float_t         MET_pt_jesFlavorPureBottomDown;
   Float_t         MET_phi_jesFlavorPureBottomDown;
   Float_t         Jet_pt_jesTimeRunBDown[36];   //[nJet]
   Float_t         Jet_mass_jesTimeRunBDown[36];   //[nJet]
   Float_t         MET_pt_jesTimeRunBDown;
   Float_t         MET_phi_jesTimeRunBDown;
   Float_t         Jet_pt_jesTimeRunCDown[36];   //[nJet]
   Float_t         Jet_mass_jesTimeRunCDown[36];   //[nJet]
   Float_t         MET_pt_jesTimeRunCDown;
   Float_t         MET_phi_jesTimeRunCDown;
   Float_t         Jet_pt_jesTimeRunDEDown[36];   //[nJet]
   Float_t         Jet_mass_jesTimeRunDEDown[36];   //[nJet]
   Float_t         MET_pt_jesTimeRunDEDown;
   Float_t         MET_phi_jesTimeRunDEDown;
   Float_t         Jet_pt_jesTimeRunFDown[36];   //[nJet]
   Float_t         Jet_mass_jesTimeRunFDown[36];   //[nJet]
   Float_t         MET_pt_jesTimeRunFDown;
   Float_t         MET_phi_jesTimeRunFDown;
   Float_t         Jet_pt_jesCorrelationGroupMPFInSituDown[36];   //[nJet]
   Float_t         Jet_mass_jesCorrelationGroupMPFInSituDown[36];   //[nJet]
   Float_t         MET_pt_jesCorrelationGroupMPFInSituDown;
   Float_t         MET_phi_jesCorrelationGroupMPFInSituDown;
   Float_t         Jet_pt_jesCorrelationGroupIntercalibrationDown[36];   //[nJet]
   Float_t         Jet_mass_jesCorrelationGroupIntercalibrationDown[36];   //[nJet]
   Float_t         MET_pt_jesCorrelationGroupIntercalibrationDown;
   Float_t         MET_phi_jesCorrelationGroupIntercalibrationDown;
   Float_t         Jet_pt_jesCorrelationGroupbJESDown[36];   //[nJet]
   Float_t         Jet_mass_jesCorrelationGroupbJESDown[36];   //[nJet]
   Float_t         MET_pt_jesCorrelationGroupbJESDown;
   Float_t         MET_phi_jesCorrelationGroupbJESDown;
   Float_t         Jet_pt_jesCorrelationGroupFlavorDown[36];   //[nJet]
   Float_t         Jet_mass_jesCorrelationGroupFlavorDown[36];   //[nJet]
   Float_t         MET_pt_jesCorrelationGroupFlavorDown;
   Float_t         MET_phi_jesCorrelationGroupFlavorDown;
   Float_t         Jet_pt_jesCorrelationGroupUncorrelatedDown[36];   //[nJet]
   Float_t         Jet_mass_jesCorrelationGroupUncorrelatedDown[36];   //[nJet]
   ...
   Float_t         FatJet_pt_jesTimeRunBUp[6];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunBUp[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunBUp[6];   //[nFatJet]
   Float_t         FatJet_pt_jesTimeRunCUp[6];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunCUp[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunCUp[6];   //[nFatJet]
   Float_t         FatJet_pt_jesTimeRunDEUp[6];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunDEUp[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunDEUp[6];   //[nFatJet]
   Float_t         FatJet_pt_jesTimeRunFUp[6];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunFUp[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunFUp[6];   //[nFatJet]
   ...
   Float_t         FatJet_pt_jesTimeRunBDown[6];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunBDown[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunBDown[6];   //[nFatJet]
   Float_t         FatJet_pt_jesTimeRunCDown[6];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunCDown[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunCDown[6];   //[nFatJet]
   Float_t         FatJet_pt_jesTimeRunDEDown[6];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunDEDown[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunDEDown[6];   //[nFatJet]
   Float_t         FatJet_pt_jesTimeRunFDown[6];   //[nFatJet]
   Float_t         FatJet_mass_jesTimeRunFDown[6];   //[nFatJet]
   Float_t         FatJet_msoftdrop_jesTimeRunFDown[6];   //[nFatJet]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmseos.fnal.gov//store/user/lnujj/VVjj_aQGC/nanoAOD_skim/Run2017_v7_18Aug2020_Hadd/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/200817_180337/E182A615-DCDA-1D46-B003-E9F70E9CE382_SkimHadd.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmseos.fnal.gov//store/user/lnujj/VVjj_aQGC/nanoAOD_skim/Run2017_v7_18Aug2020_Hadd/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/200817_180337/E182A615-DCDA-1D46-B003-E9F70E9CE382_SkimHadd.root");
      }
